...
urlpatterns = [
    ...
    path(
        "update/<int:pk>/", views.CampaignUpdateView.as_view(), name="campaign-update"
    ),
    path(
        "delete/<int:pk>/", views.CampaignDeleteView.as_view(), name="campaign-delete"
    ),
    ...
    path(
        "<int:campaign_id>/slot/create",
        views.SlotCreateView.as_view(),
        name="slot-create",
    ),
    path(
        "<int:campaign_id>/slot/update/<int:pk>/",
