...
urlpatterns = [
    ...
    path(
        "detail/<int:pk>/", views.VaccinationDetail.as_view(), name="vaccination-detail"
    ),
    path("choose-vaccine/", views.ChooseVaccine.as_view(), name="choose-vaccine"),
    path(
        "choose-campaign/<int:vaccine_id>/",
        views.ChooseCapmaign.as_view(),
    ...
    path(
        ...
        views.ConfirmVacinnation.as_view(),
        name="confirm-vaccination",
    ),
    path(
        "appointment-letter/<int:vaccination_id>/",
